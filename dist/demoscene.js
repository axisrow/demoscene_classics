...
void main() {
  ...
  var FEEDBACK_PROFILES = buildProfiles({
    ...
    "preview.desktop": { ...RUNTIME_PREVIEW_DESKTOP9, ...PREVIEW_RENDER3 },
    "preview.mobile": { ...RUNTIME_PREVIEW_MOBILE9, ...PREVIEW_RENDER3 }
  });
  ...
  var PREVIEW_RENDER4 = { render: { resolution: 0.3 } };
  var COPPER_BARS_PROFILES = buildProfiles({
    ...
    "preview.desktop": { ...RUNTIME_PREVIEW_DESKTOP10, ...BARS_DESKTOP, ...PREVIEW_RENDER4 },
    "preview.mobile": { ...RUNTIME_PREVIEW_MOBILE10, ...BARS_MOBILE, ...PREVIEW_RENDER4 }
  });
