...
void main() {
  ...
  var PREVIEW_RENDER3 = { render: { resolution: 0.7 } };
  ...
  var SINE_SCROLLER_PROFILES = buildProfiles({
    "fullscreen.desktop": { ...RUNTIME_FULLSCREEN_DESKTOP7, ...GEOMETRY_DESKTOP, ...STARS_DESKTOP },
    "fullscreen.mobile": { ...RUNTIME_FULLSCREEN_MOBILE7, ...GEOMETRY_MOBILE, ...STARS_MOBILE },
    "preview.desktop": { ...RUNTIME_PREVIEW_DESKTOP7, ...GEOMETRY_DESKTOP, ...STARS_PREVIEW_DESKTOP, ...PREVIEW_RENDER3 },
    "preview.mobile": { ...RUNTIME_PREVIEW_MOBILE7, ...GEOMETRY_MOBILE, ...STARS_PREVIEW_MOBILE, ...PREVIEW_RENDER3 }
  });
  ...
  var CLASSIC_PALETTE2 = Object.freeze([
    "#04060a",
  ...
  var RENDER_FULLSCREEN2 = { render: { resolution: 0.5 } };
  var RENDER_FULLSCREEN_MOBILE3 = { render: { resolution: 0.4 } };
  var RENDER_PREVIEW2 = { render: { resolution: 0.3 } };
  var RENDER_PREVIEW_MOBILE3 = { render: { resolution: 0.22 } };
  var ROTOZOOM_PROFILES = buildProfiles({
    "fullscreen.desktop": { ...RUNTIME_FULLSCREEN_DESKTOP8, ...RENDER_FULLSCREEN2 },
    "fullscreen.mobile": { ...RUNTIME_FULLSCREEN_MOBILE8, ...RENDER_FULLSCREEN_MOBILE3 },
    "preview.desktop": { ...RUNTIME_PREVIEW_DESKTOP8, ...RENDER_PREVIEW2 },
    "preview.mobile": { ...RUNTIME_PREVIEW_MOBILE8, ...RENDER_PREVIEW_MOBILE3 }
  });
  ...
  var COPPER_BARS_PROFILES = buildProfiles({
    ...
    "preview.desktop": { ...RUNTIME_PREVIEW_DESKTOP10, ...BARS_DESKTOP, ...PREVIEW_RENDER5 },
    "preview.mobile": { ...RUNTIME_PREVIEW_MOBILE10, ...BARS_MOBILE, ...PREVIEW_RENDER5 }
  });
