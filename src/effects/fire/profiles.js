...
// drift, source density) is owned by config.js; profiles only tune execution
// budgets. Fullscreen slots keep the classic composition (render.resolution
// stays at the 0.25 default); preview slots lower the sampling cost to the
// value the gallery previously used, so the card shows the same rising heat at
// a coarser buffer.
//
...
// 1 and viewport auto-pause is enabled everywhere until the fire tuning issue
// (#6) revisits them.
